...
<form action="register.php" method="POST" accept-charset="utf-8">
    ...
    echo "<span class=\"help-block\">Somente letras e números são permitidos.</span>";
    create_form_input('email', 'email', 'Email Address', $reg_errors);
    create_form_input('pass1', 'password', 'Password', $reg_errors);
    echo "<span class=\"help-block\">Sua senha deve ter pelo menos 6 caracteres, com pelo menos uma letra minúscula, uma letra maiúscula e um número.</span>";
